...
@Entity
@Table(name = "orders", schema = "myshop_database")
public class OrderEntity {
    ...
    @Column(name = "Purchases", nullable = false, length = 50)
    private String purchases;
    @Column(name = "Addressee", nullable = true, length = 50)
    private String addressee;
    @Column(name = "WithCurier", nullable = false)
    ...
    public OrderEntity(String userName, String purchases, byte withCurier, int shopId) {
    ...
    public OrderEntity(String userName, String purchases, byte withCurier, String addressee) {
        this.userName = userName;
        this.purchases = purchases;
